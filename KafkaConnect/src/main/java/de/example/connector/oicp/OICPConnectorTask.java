...
public class OICPConnectorTask extends SourceTask {
    static final Logger log = LoggerFactory.getLogger(OICPConnectorTask.class);
    ...
    public void start(Map<String, String> map) {
        topic = map.get(OICPConnectorConfig.TOPIC_SETTING);
        pollInterval = Integer.parseInt(map.get(OICPConnectorConfig.POLL_INTERVAL_SETTING));
        serverAddress = map.get(OICPConnectorConfig.SERVER_ADDRESS_SETTING);
    ...
    public List<SourceRecord> poll() {
        ...
        try {
            ...
            if (response.isSuccessful() && response.body() != null) {
                ...
                List<LocationOICP> locations = mapper.readValue(data, new TypeReference<List<LocationOICP>>() {});
                for (LocationOICP location : locations) {
